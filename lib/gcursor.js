...
gcursor.axis2key = function (axis) {
  if (axis === gcursor.mapping.axisX) {
    return 'x';
  } else if (axis === gcursor.mapping.axisY) {
    return 'y';
  }
};
...
gcursor.start = function (e) {
  gcursor.dest[gcursor.axis2key(e.axis)] = e.value;
...
gcursor.onGamepadAxisMove = function (e) {
  if (e.axis !== gcursor.mapping.axisX && e.axis !== gcursor.mapping.axisY) {
    return;
  }
